...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    static final class CustomUserDetails extends CustomUser implements UserDetails {
        ...
        CustomUserDetails(CustomUser customUser) {
            super(customUser.getId(), customUser.getEmail(), customUser.isAdmin(), customUser.getPassword());
        }

        @Override
        public Collection<? extends GrantedAuthority> getAuthorities() {
            if (isAdmin()) {
                return unmodifiableList(createAuthorityList("ROLE_ADMIN"));
            }
            return unmodifiableList(createAuthorityList("ROLE_USER"));
        }
